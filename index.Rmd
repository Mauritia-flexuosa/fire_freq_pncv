# Frequência de fogo no Parque Nacional da Chapada dos Veadeiros

## Dados do mapbiomas

## Período de 1985 a 2018
...
firefreq <- raster("/home/marcio/datasets/dados 2021/mapbiomas-brazil-collection-10-parnadachapadadosveadeiros-1985_2018.tif")
...
# Tree cover a partir dos dados do Hansen
...
tc <- raster("./datasets/dados 2021/Hansen_GFC-2019-v1.7_treecover2000_10S_050W.tif")

UCs <- sf::st_read("/home/marcio/datasets/UC_fed_julho_2019/UC_fed_julho_2019.shp")
chapada <- UCs[302,][2]
